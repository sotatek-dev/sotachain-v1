local1:
	./target/release/node-template purge-chain --base-path /tmp/node01 --chain specs/localnetRaw.json
...
local2:
	./target/release/node-template purge-chain --base-path /tmp/node02 --chain specs/localnetRaw.json
...
local3:
	./target/release/node-template purge-chain --base-path /tmp/node03 --chain specs/localnetRaw.json
